...
export interface SourceOptions {
    ...
    networkOptions: RequestInit; // TODO: Change type to add crossOrigin
    attribution: string;
    extent: Extent;
}

export default abstract class Source implements InformationsData {
    ...
    whenReady: Promise<Source>; // TODO: Or maybe not?
